...
Info:
============================================
Plugin Name: Enhanced Account Switcher for MyBB 1.6.*
...
-> Switch between linked account without having to log out and in
...
Version: 1.2 (03-25-2013)

============================================
Changelog:
============================================
compared to the Account Switcher plugin...

-Several vulnerabilities fixed
-Less database queries due to use of MyBB's cache system
-Settings added in ACP (Configuration - Settings - Enhanced Account Switcher)
-Function added: Switch user box can additionally be displayed next to the Send Post Button
-Function added: Post author can be altered afterwards (between attached accounts)
-Function added: Display of attached users in profile
-Function added: Header notice if an attached user got a new PM
-Function added: Apply away status of the master account to all attached users
